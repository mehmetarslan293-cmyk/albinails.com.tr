...
/** Tilda albinails.ru — Men koleksiyonu (6 ton, iletişim temalı isimler; tek seri kartı + modal). */
...
/** Tilda albinails.ru — Butterfly koleksiyonu (6 duo-krom ton; tek seri kartı + modal). */
...
const getBrandForFilter = (product) => {
  const brand = String(product?.brand || "Kalipso").trim() || "Kalipso";
